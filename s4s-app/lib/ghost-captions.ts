...
export const GHOST_CAPTIONS = [
  ...
  "{username} just turned 18 and made an of omg",
...
export const PINNED_CAPTIONS = [
  ...
  "{username} just turned 18 and her vip is free rn 🤭",
  "my roommate {username} has free vip for 24 hrs go look",
  "{username} literally just turned 18 go sub its free 💕",
  "free vip on {username} today shes brand new",
  "{username} from my college just made her page free",
  "shes 18 and free vip for today only {username} 👀",
  "my sorority sister {username} just dropped a free page",
  "{username} turned 18 and made a free of lol go see",
  "free 24hr vip on {username} shes so cute",
  "{username} just turned 18 her page is free rn go",
  ...
  "my friend {username} just turned 18 and shes free rn",
  ...
  "{username} is 18 and giving free access go look 👀",
  "my college bestie {username} made her page free today",
  "free vip {username} she just turned 18 🤭",
  ...
  "go follow {username} shes free and just turned 18",
  ...
  "{username} just turned 18 free vip go before she changes it",
]
